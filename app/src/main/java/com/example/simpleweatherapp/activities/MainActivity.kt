package com.example.simpleweatherapp.activities
...
import com.example.simpleweatherapp.utilities.ApiUtilities
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey="a230cd4f84e332a07521c6b8c75cd31a"
    ...
    private fun getCityWeather(city: String) {
        ...
        ApiUtilities.getApiInterface()?.getCityWeatherData(city,apiKey)
            ?.enqueue(object :Callback<com.example.simpleweatherapp.models.WeatherModels>{
                @RequiresApi(Build.VERSION_CODES.O)
                override fun onResponse(call: Call<com.example.simpleweatherapp.models.WeatherModels>, response: Response<com.example.simpleweatherapp.models.WeatherModels>) {
                ...
                override fun onFailure(call: Call<com.example.simpleweatherapp.models.WeatherModels>, t: Throwable) {
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    private fun setData(body: com.example.simpleweatherapp.models.WeatherModels){
